  ...
  Future<void> connect() async {
    try {
      _db = await mongo.Db.create(
        'mongodb+srv://galiciastrda:Z3Y8OJpf6S2oxRfa@cluster0.0dxbd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
      await _db.open();
      _db.databaseName= 'productos';
      print('Conexion a MongoDB establecida');
    } on SocketException catch (e) {
      print('Error de conexion: $e');
    rethrow; //Vuelve a lanzar la excepcion despues de imprimir el mensaje
  }
  }
